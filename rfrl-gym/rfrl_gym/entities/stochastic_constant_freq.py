...
class StochasticConstantFreq(Entity):
    def __init__(self, entity_label:str, num_channels: int, channels: list, onoff: list = [1,1,0],
        ...
        """
        An Entity which stochastically turns on and off based on percent_on value. Single channel constant freq
        Args:
            ...
            percent_on: float value in (0,1) defining the percentage of steps the entity operates (1 = 100%)
        """
